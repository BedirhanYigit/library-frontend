          ...
          <div className="books-grid">
            {loanedItems.map((item) => (
              <div key={item.id} className="book-card">
                ...
                <p className="book-detail"><strong>Author:</strong> {item.author || 'N/A'}</p>
                <p className="book-detail"><strong>Genre:</strong> {item.genre || 'N/A'}</p>
                <p className="book-detail"><strong>ISBN:</strong> {item.isbn || 'N/A'}</p>
                
                <p className="book-detail"><strong>Loaned On:</strong> {item.loanDate}</p>
                <p className="book-detail" style={{ color: '#ef4444' }}><strong>Due Date:</strong> {item.dueDate}</p>
                
                <p className="book-status status-loaned">
                  CURRENTLY LOANED
                </p>
